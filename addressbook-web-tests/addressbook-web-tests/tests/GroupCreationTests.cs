...
namespace WebAddressbookTests
{
    ...
    public class GroupCreationTests : AuthTestBase
    {
        ...
        {
            List<GroupData> groups = new List<GroupData>();
            return (List<GroupData>) // приведение типа для объекта(мы знаем какого типа этот объект)
                new XmlSerializer(typeof(List<GroupData>))
                    .Deserialize(new StreamReader(@"groups.xml")); // читает данные из указанного файла
        }
